        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              ...
              <li>Resell or redistribute our recommendations without authorization</li>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              you upload. By uploading content, you grant us a license to use it to provide and improve
              our services.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              While we strive to provide accurate recommendations based on university research:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              <li>Our recommendations are advisory in nature and should not replace professional agronomic consultation for critical decisions</li>
              <li>Results may vary based on local conditions, weather, and other factors not captured in soil tests</li>
              <li>We do not guarantee specific yield outcomes or results</li>
              <li>You are responsible for verifying recommendations are appropriate for your specific situation</li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, AI AGRONOMIST SHALL NOT BE LIABLE FOR ANY
              INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT
              LIMITED TO LOSS OF PROFITS, CROP LOSSES, OR AGRICULTURAL DAMAGES, ARISING FROM YOUR
              USE OF THE SERVICE OR RELIANCE ON OUR RECOMMENDATIONS.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              these terms or for any other reason at our discretion. You may also terminate your
