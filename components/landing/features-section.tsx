...
export function FeaturesSection() {
  const features = [
    ...
    {
      icon: BarChart3,
      title: "Crop-Specific Rates",
      description:
        "Precise fertilizer rates calculated for your specific crop and yield goals.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Powerful features designed specifically for modern farmers who want data-driven decisions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:bg-white hover:shadow-xl hover:border-transparent transition-all duration-300"
            >
              <div
